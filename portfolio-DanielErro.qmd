...
I do not typically seek out new packages that I have not used before to accomplish tasks in my code. However, I am usually able to adapt to different syntax styles, as well as find and use tutorials to enhance my understanding of new concepts. (link a tidyverse example).
...
I can now use Git and GitHub proficiently to track my progress and collaborate with group members. However, most of our projects and labs in GitHub have been set up by group mates rather than myself, so I do not feel as if I have mastered all of the collaboration tools of GitHub. (not sure)
...
My code could oftentimes use more comments in order for it to be more readable, especially to other people. My code is usually organized, but comments would make it more readable and clear. I use a package-based workflow by loading in all of my packages at the beginning of the document, which keeps my code organized. To reach level 3 and maybe even level 4, I need to start commenting my code much more often. (add PR with adding libraries)
...
I can both read data sets into R as well as clean them. I have also proven that I can deal with poor formatting in a data set. (link mapping example PR)
...
I have used mapping in a custom function to clean a variable in a data set. However, I have not yet shown that I can cleverly use pivoting, grouping, and joining to wrangle data. (link mapping example PR)
...
I do not have much experience in using less common geometries, especially those from ggplot extension packages. However, I am confident in my ability to use correct aesthetics to map variables. I also understand how geometries inherit aesthetics. (find ggplot example)
...
I can confidently edit the titles, subtitles, captions, and axis labels to create a clearly labelled plot. I also understand the grammar of graphics, and what a visually pleasing plot should look like. I can choose colors and themes to make the visually pleasing plot. (find ggplot example)
...
I am able to create a functional Shiny app. I also understand the principle of reactivity, and have implemented it in my Shiny apps. However, much of the syntax for coding a Shiny app is new to me, so I often have to use Google to figure out the proper syntax for what I want to do. (link to reactivity in shiny app (practice activity))
