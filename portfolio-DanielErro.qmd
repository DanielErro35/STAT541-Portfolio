...
I do not typically seek out new packages that I have not used before to accomplish tasks in my code. However, I am usually able to adapt to different syntax styles, as well as find and use tutorials to enhance my understanding of new concepts.
...
I commonly use online resources (primarily Google and StackOverflow) to solve problems and debug my code. I have not yet mastered reading the documentation of APIs to figure out how to access data, which is why I have not reached level 3 for this learning objective.
...
I can now use Git and GitHub proficiently to track my progress and collaborate with group members. However, most of our projects and labs in GitHub have been set up by group mates rather than myself, so I do not feel as if I have mastered all of the collaboration tools of GitHub.
...
My code could oftentimes use more comments in order for it to be more readable, especially to other people. My code is usually organized, but comments would make it more readable and clear. I use a package-based workflow by loading in all of my packages at the beginning of the document, which keeps my code organized. To reach level 3 and maybe even level 4, I need to start commenting my code much more often.
...
I am able to create a functional Shiny app. I also understand the principle of reactivity, and have implemented it in my Shiny apps. However, much of the syntax for coding a Shiny app is new to me, so I often have to use Google to figure out the proper syntax for what I want to do.
